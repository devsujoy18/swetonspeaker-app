...
Route::get('/product-enquiry', function () { return view('pages.product_enquiry'); })->name('product.enquiry');
...
Route::get('/application-for-dealership', function () { return view('pages.application_for_dealership'); })->name('application.dealership');
...
Route::get('/contact-us', function () { return view('pages.contact_us'); })->name('contact.us');
