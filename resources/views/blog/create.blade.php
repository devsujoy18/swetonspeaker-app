                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="video_link" class="form-control" placeholder="Enter Video Link" value="{{ old('video_link') }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="long_description" class="form-control summernote" placeholder="Enter Long Description">{{ old('long_description') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_current_event" value="1" @if(old('is_current_event') == '1') checked @endif>
                            ...
                            <div class="form-group">
                                ...
                                <select id="show_main_image_on_details" name="show_main_image_on_details" class="form-control">
                                    <option value="1" @selected((string) old('show_main_image_on_details', '1') === '1')>Yes</option>
                                    <option value="0" @selected((string) old('show_main_image_on_details', '1') === '0')>No</option>
                                </select>
