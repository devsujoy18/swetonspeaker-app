       ...
       <!--Page Header Start-->
        ...
        <section class="skill-one about-page__skill-one">
            ...
            <div class="wthree_head_section">
				<h3 style="font-size:32px;" class="w3l_header w3_agileits_header">Terms &amp; conditions</h3>
			</div>
...
<p>
    By accessing and placing an order with SWETONSPEAKERS, you confirm that you
...
<p>
    Under no circumstances shall SWETONSPEAKERS team be liable for any direct,
    ...
    inability to use, the materials on this site, even if SWETONSPEAKERS team
...
<p>
    SWETONSPEAKERS will not be responsible for any outcome that may occur
...
<p>
    SWETONSPEAKERS grants you a revocable, non-exclusive, non-transferable,
    limited license to download, install and use the website strictly in
    accordance with the terms of this Agreement.
</p>
<p>
    These Terms &amp; Conditions are a contract between you and SWETONSPEAKERS
    (referred to in these Terms &amp; Conditions as "SWETONSPEAKERS", "us",
    "we" or "our"), the provider of the SWETONSPEAKERS website and the services
    accessible from the SWETONSPEAKERS website (which are collectively referred
    to in these Terms &amp; Conditions as the "SWETONSPEAKERS Service").
</p>
<p>
    You are agreeing to be bound by these Terms &amp; Conditions. If you do not
    agree to these Terms &amp; Conditions, please do not use the SWETONSPEAKERS
...
<ul type="disc">
    <li>
        ...
        700146), that is responsible for your information under this Terms
        &amp; Conditions.
    </li>
</ul>
<ul type="disc">
    <li>
        Country: where SWETONSPEAKERS or the owners/founders of SWETONSPEAKERS
        are based, in this case is India
    </li>
    <li>
        Device: any internet connected device such as a phone, tablet, computer
        or any other device that can be used to visit SWETONSPEAKERS and use
        the services.
    </li>
    <li>
        Service: refers to the service provided by SWETONSPEAKERS as described
...
<ul type="disc">
    ...
    <li>
        ...
        of copyright or trademark) of SWETONSPEAKERS or its affiliates,
...
<p>
    If you pay for any of our one-time payment plans, you agree to pay all fees
    or charges to your account for the Service in accordance with the fees,
    charges and billing terms in effect at the time that each fee or charge is
    due and payable. Your Payment Provider agreement governs your use of the
    designated credit card account, and you must refer to that agreement and
    not these Terms to determine your rights and liabilities with respect to
    your Payment Provider. By providing SWETONSPEAKERS with your credit card
    number and associated payment information, you agree that SWETONSPEAKERS is
    authorized to verify information immediately, and subsequently invoice your
    account for all fees and charges due and payable to SWETONSPEAKERS
    hereunder and that no additional notice or consent is required. You agree
    to immediately notify SWETONSPEAKERS of any change in your billing address
    or the credit card used for payment hereunder. SWETONSPEAKERS reserves the
...
<p>
    No contract will exist between you and SWETONSPEAKERS for the Service until
    SWETONSPEAKERS accepts your order by a confirmatory e-mail, SMS/MMS
    message, or other appropriate means of communication.
</p>
<p>
    You are responsible for any third-party fees that you may incur when using
    the Service.
</p>
<p>
...
<p>
    Thanks for shopping at SWETONSPEAKERS. We appreciate the fact that you like
...
<p>
    ...
    to transactions at SWETONSPEAKERS. We’ll be as brief as our attorneys will
    allow. The main thing to remember is that by placing an order or making a
    purchase at SWETONSPEAKERS, you agree to the terms along with
    SWETONSPEAKERS’s Privacy Policy.
</p>
<p>
...
<p>
    ...
    "Suggestions") provided by you to SWETONSPEAKERS with respect to the
    website shall remain the sole and exclusive property of SWETONSPEAKERS.
</p>
<p>
    SWETONSPEAKERS shall be free to use, copy, modify, publish, or redistribute
...
<p>
    ...
    SWETONSPEAKERS. We are not responsible for the content, accuracy or
    ...
    and interaction on any other website, including those that have a link on
...
<p>
    SWETONSPEAKERS uses "Cookies" to identify the areas of our website that you
    ...
    every time you visit the website as we would not be able to remember that
    you had logged in previously. Most web browsers can be set to disable the
...
<p>
    You acknowledge and agree that SWETONSPEAKERS may stop (permanently or
    temporarily) providing the Service (or any features within the Service) to
    you or to users generally at SWETONSPEAKERS’s sole discretion, without
    prior notice to you. You may stop using the Service at any time. You do not
    need to specifically inform SWETONSPEAKERS when you stop using the Service.
    You acknowledge and agree that if SWETONSPEAKERS disables access to your
...
<p>
    <strong>Modifications to Our website</strong>
</p>
<p>
    SWETONSPEAKERS reserves the right to modify, suspend or discontinue,
...
<p>
    <strong>Updates to Our website</strong>
</p>
<p>
    SWETONSPEAKERS may from time to time provide enhancements or improvements
...
<p>
    ...
    website. You agree that SWETONSPEAKERS has no obligation to (i) provide any
...
<p>
    You acknowledge and agree that SWETONSPEAKERS shall not be responsible for
    any Third-Party Services, including their accuracy, completeness,
    timeliness, validity, copyright compliance, legality, decency, quality or
    any other aspect thereof. SWETONSPEAKERS does not assume and shall not have
...
<p>
    SWETONSPEAKERS may, in its sole discretion, at any time and for any or no
...
<p>
    ...
    SWETONSPEAKERS, in the event that you fail to comply with any provision of
...
<p>
    Termination of this Agreement will not limit any of SWETONSPEAKERS's rights
...
<p>
    ...
    on our website constitutes an infringement on your copyright, please
    ...
    and (e) the a statement that the information in the notification is
    accurate, and, under penalty of perjury you are authorized to act on behalf
    of the owner.
</p>
<p>
...
<p>
    You agree to indemnify and hold SWETONSPEAKERS and its parents,
...
<p>
    ...
    permitted under applicable law, SWETONSPEAKERS, on its own behalf and on
    ...
    foregoing, SWETONSPEAKERS provides no warranty or undertaking, and makes no
    ...
    software, websites, systems or services, operate without interruption, meet
    any performance or reliability standards or be error free or that any
    errors or defects can or will be corrected.
</p>
<p>
    Without limiting the foregoing, neither SWETONSPEAKERS nor any
    SWETONSPEAKERS's provider makes any representation or warranty of any kind,
    express or implied: (i) as to the operation or availability of the website,
    or the information, content, and materials or products included thereon;
    (ii) that the website will be uninterrupted or error-free; (iii) as to the
    ...
    e-mails sent from or on behalf of SWETONSPEAKERS are free of viruses,
...
<p>
    ...
    SWETONSPEAKERS and any of its suppliers under any provision of this
...
<p>
    ...
    SWETONSPEAKERS or its suppliers be liable for any special, incidental,
    indirect, or consequential damages whatsoever (including, but not limited
    to, damages for loss of profits, for loss of data or other information, for
    business interruption, for personal injury, for loss of privacy arising out
    ...
    SWETONSPEAKERS or any supplier has been advised of the possibility of such
...
<p>
    ...
    notices published by SWETONSPEAKERS on the Services, shall constitute the
    entire agreement between you and SWETONSPEAKERS concerning the Services. If
    ...
    SWETONSPEAKERS’s failure to assert any right or provision under this
    Agreement shall not constitute a waiver of such right or provision. YOU AND
    SWETONSPEAKERS AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED TO
...
<p>
    SWETONSPEAKERS reserves the right, at its sole discretion, to modify or
...
<p>
    ...
    to the new terms, you are no longer authorized to use SWETONSPEAKERS.
</p>
<p>
...
<p>
    ...
    SWETONSPEAKERS regarding your use of the website and supersedes all prior
...
<p>
    ...
    use or purchase other SWETONSPEAKERS's services, which SWETONSPEAKERS will
...
<p>
    ...
    continue to use the Service, you will be bound by the updated Terms. If you
    do not want to agree to these or any updated Terms, you can delete your
    account.
</p>
<p>
...
<p>
    ...
    SWETONSPEAKERS, its licensors or other providers of such material and are
    protected by India and international copyright, trademark, patent, trade
    secret and other intellectual property or proprietary rights laws. The
    material may not be copied, modified, reproduced, downloaded or distributed
    in any way, in whole or in part, without the express prior written
    permission of SWETONSPEAKERS, unless and except as is expressly provided in
...
<p>
    ...
    ENFORCEMENT OR VALIDITY OF YOUR OR SWETONSPEAKERS’s INTELLECTUAL PROPERTY
    RIGHTS. The term “dispute” means any dispute, action, or other controversy
    between you and SWETONSPEAKERS concerning the Services or this agreement,
...
<p>
    In the event of a dispute, you or SWETONSPEAKERS must give the other a
    ...
    Dispute via email to: sales@swetonspeakers.com. SWETONSPEAKERS will send
    any Notice of Dispute to you by mail to your address if we have it, or
    otherwise to your email address. You and SWETONSPEAKERS will attempt to
    ...
    SWETONSPEAKERS may commence arbitration.
</p>
<p>
    <strong>Binding Arbitration</strong>
</p>
<p>
    If you and SWETONSPEAKERS don’t resolve any dispute by informal
    ...
    seek any interim or preliminary injunctive relief from any court of
...
<p>
    ...
    become the sole property of Sweton without any compensation or credit
    to you whatsoever. Sweton and its affiliates shall have no obligations
...
<p>
    SWETONSPEAKERS may, from time to time, include contests, promotions,
...
<p>
    ...
    Sweton. Sweton will be entitled to injunctive or other equitable
    relief (without the obligations of posting any bond or surety) in the event
    of any breach or anticipatory breach by you. Sweton operates and
    controls the Sweton Service from its offices in country. The
    Service is not intended for distribution to or use by any person or entity
    in any jurisdiction or country where such distribution or use would be
    contrary to law or regulation. Accordingly, those persons who choose to
    access the Sweton Service from other locations do so on their own
    ...
    (which include and incorporate the Sweton Privacy Policy) contains the
    entire understanding, and supersedes all prior understandings, between you
    and Sweton concerning its subject matter, and cannot be changed or
...
<ul type="disc">
    ...
    <li>
        Via Phone Number: +919831011477
    </li>
    <li>
        Via this Link: www.swetonspeakers.com
    </li>
</ul>
</div>
             </div>
