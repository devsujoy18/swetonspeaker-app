						...
						<div class="col-sm-6">
							...
							<div class="form-group">
				              	...
				              	<select class="custom-select" name="type_id">
					                ...
					                <option value="1" @selected(old('type_id', $category->type_id) == "1")>PRO LOUDSPEAKER </option>
					                <option value="2" @selected(old('type_id', $category->type_id) == "2")>HOME LOUDSPEAKER </option>
					            </select>
				            ...
				            <div class="form-group">
					            ...
					            <div class="form-check">
						            <input class="form-check-input" type="checkbox" name="show_on_home" value="1" @if(old('show_on_home', $category->show_on_home) == '1') checked @endif>
						            <label class="form-check-label">Yes</label>
					            </div>
				            </div> 
							<div class="form-group">
								<label>Order No<span class="text-danger">*</span></label>
								<input type="text" name="order_no" class="form-control" placeholder="Enter order no" value="{{ old('order_no',  $category->order_no) }}">
							...
							<div class="form-group">
				                <img src="{{ url('/') }}/uploads/thumbnails/{{ $category->image }}" style="height:60px;width: 60px;">
				            </div>
						</div>
					</div>
