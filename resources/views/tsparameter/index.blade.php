<x-admin_layout>
	<x-admin_breadcrumb>
	    ...
	    <x-slot:breadcrumb_list>
	        <li class="breadcrumb-item active"> Tsparameters</li>
	    </x-slot>
	</x-admin_breadcrumb>
	<section class="content">
	    ...
	    <x-admin_card>
	    	...
	    	<x-slot:card_tools>
	    		<a class="btn btn-primary btn-sm" href="{{ route('tsparameter.create')}}">
			        ...
			        <tbody>
			        	...
			        	<tr>
			        		...
			        		<td>
			        			<x-admin_editbtn>
			        				<x-slot:edit_link>
			        					{{ route('tsparameter.edit', $tsparameter->id) }}
			        				</x-slot>
			        			</x-admin_editbtn>

			        			@if($tsparameter->status == 0)
			        			<x-admin_changestatusbtn>
			        				<x-slot:status_link>{{ route('tsparameter.status', $tsparameter->id) }}</x-slot>
