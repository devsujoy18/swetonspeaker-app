            ...
            <div class="review-form-one__inner">
                ...
                <div class="review-form-one__rate-box">
                    ...
                    <div class="review-form-one__rate">
                        @for ($i = 1; $i <= 5; $i++)
                            <i class="fa fa-star" wire:click="$set('userRate', {{ $i }})"
                               style="cursor: pointer; color: {{ $userRate >= $i ? '#cf1f1f' : '#ddd' }};"></i>
                        @endfor
                    </div>
                    @error('userRate') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
