<x-admin_layout>
	...
	<section class="content">
	    <x-admin_card>
	    	...
	    	<x-slot:card_body>
	    		<form role="form" action="{{ route('reconkit.update', $reconkit->id) }}" method="POST" enctype="multipart/form-data">
	    			@csrf
	    			@method('PUT')
	    			<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" name="name" class="form-control" placeholder="Enter Name" value="{{ old('name', $reconkit->name) }}">
                                @if($errors->has('name'))
							...
							<div class="form-group">
								...
								<input type="text" name="order_no" class="form-control" placeholder="Enter order no" value="{{ old('order_no',  $reconkit->order_no) }}">
