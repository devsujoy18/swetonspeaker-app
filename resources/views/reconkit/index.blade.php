<x-admin_layout>
	<x-admin_breadcrumb>
	    ...
	    <x-slot:breadcrumb_list>
	        <li class="breadcrumb-item active"> Reconkits</li>
	    </x-slot>
	</x-admin_breadcrumb>
	<section class="content">
	    ...
	    <x-admin_card>
	    	...
	    	<x-slot:card_tools>
	    		<a class="btn btn-primary btn-sm" href="{{ route('reconkit.create')}}">
			        ...
			        <tbody>
			        	...
			        	<tr>
			        		...
			        		<td>
			        			<x-admin_editbtn>
			        				<x-slot:edit_link>
			        					{{ route('reconkit.edit', $reconkit->id) }}
			        				</x-slot>
			        			</x-admin_editbtn>

			        			@if($reconkit->status == 0)
			        			<x-admin_changestatusbtn>
			        				<x-slot:status_link>{{ route('reconkit.status', $reconkit->id) }}</x-slot>
