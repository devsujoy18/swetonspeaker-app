<x-admin_layout>
	...
	<section class="content">
	    ...
	    <x-admin_card>
	    	...
	    	<x-slot:card_body>
	    		<form role="form" action="{{ route('combination.tsparameter.update', $producttsparameter->id) }}" method="POST" enctype="multipart/form-data">
	    			@csrf
	    			@method('PUT')
	    			<div class="form-group">
	                    ...
	                    <select class="custom-select" name="tsparameter_id">
	                        ...
	                        <option value="{{ $tsparameter->id }}" 
	                        	@selected(old('tsparameter_id', $producttsparameter->tsparameter_id) == $tsparameter->id)>{{ $tsparameter->name }}</option>
	                        @endforeach
	                    </select> 
	                ...
	                <div class="form-group">
	                    ...
	                    <input type="text" name="value" class="form-control" placeholder="Enter value" value="{{ old('value', $producttsparameter->value) }}">
	                    @if($errors->has('value'))
	                ...
	                <div class="form-group">
	                    ...
	                    <input type="text" name="order_no" class="form-control" placeholder="Enter order no" value="{{ old('order_no', $producttsparameter->order_no) }}">  
