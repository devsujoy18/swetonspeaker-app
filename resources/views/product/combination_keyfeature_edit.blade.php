<x-admin_layout>
	...
	<section class="content">
	    ...
	    <x-admin_card>
	    	...
	    	<x-slot:card_body>
	    		<form role="form" action="{{ route('combination.keyfeature.update', $productkeyfeature->id) }}" method="POST" enctype="multipart/form-data">
	    			@csrf
	    			@method('PUT')
	    			<div class="form-group">
	                    ...
	                    <select class="custom-select" name="keyfeature_id">
	                        ...
	                        <option value="{{ $keyfeature->id }}" 
	                        	@selected(old('keyfeature_id', $productkeyfeature->keyfeature_id) == $keyfeature->id)>{{ $keyfeature->name }}</option>
	                        @endforeach
	                    </select> 
	                ...
	                <div class="form-group">
	                    ...
	                    <input type="text" name="keyfeature_value" class="form-control" placeholder="Enter keyfeature value" value="{{ old('keyfeature_value', $productkeyfeature->value) }}">
	                ...
	                <div class="form-group">
	                    ...
	                    <input type="text" name="order_no" class="form-control" placeholder="Enter order no" value="{{ old('order_no', $productkeyfeature->order_no) }}">  
