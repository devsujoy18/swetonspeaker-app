<x-admin_layout>
	...
	<section class="content">
	    ...
	    <x-admin_card>
	    	...
	    	<x-slot:card_body>
	    		<form role="form" action="{{ route('combination.reconkit.store', $combinationId) }}" method="POST" enctype="multipart/form-data">
	    			@csrf
	    			<div class="form-group">
	                    ...
	                    <select class="custom-select" name="reconkit_id">
	                        ...
	                        <option value="{{ $reconkit->id }}" 
	                        	@selected(old('reconkit') == $reconkit->id)>{{ $reconkit->name }}</option>
	                        @endforeach
	                    </select> 
