<x-admin_layout>
	...
	<section class="content">
	    ...
	    <x-admin_card>
	    	...
	    	<x-slot:card_body>
	    		<form role="form" action="{{ route('combination.mountinginfo.store', $combinationId) }}" method="POST" enctype="multipart/form-data">
	    			@csrf
	    			<div class="form-group">
	                    ...
	                    <select class="custom-select" name="mountinginfo_id">
	                        ...
	                        <option value="{{ $mountinginfo->id }}" 
	                        	@selected(old('mountinginfo_id') == $mountinginfo->id)>{{ $mountinginfo->name }}</option>
	                        @endforeach
	                    </select> 
