<x-admin_layout>
	...
	<section class="content">
	    <x-admin_card>
	    	...
	    	<x-slot:card_body>
	    		<form role="form" action="{{ route('product.combination.store', $product->id) }}" method="POST" enctype="multipart/form-data">
	    			@csrf
	    			<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label>Name <span class="text-danger">*</span></label>
								<input type="text" name="name" class="form-control" placeholder="Enter order no" value="{{ old('name') }}">
                                @if($errors->has('name'))
