<x-admin_layout>
	<x-admin_breadcrumb>
	    ...
	    <x-slot:breadcrumb_list>
	        <li class="breadcrumb-item"><a href="{{ route('product.index') }}"> specifications </a></li>
	...
	<section class="content">
	    ...
	    <x-admin_card>
	    	...
	    	<x-slot:card_body>
	    		<form role="form" action="{{ route('combination.specification.store', $combinationId) }}" method="POST" enctype="multipart/form-data">
	    			@csrf
	    			<div class="form-group">
	                    ...
	                    <select class="custom-select" name="specification_id">
	                        ...
	                        <option value="{{ $specification->id }}" 
	                        	@selected(old('specification') == $specification->id)>{{ $specification->name }}</option>
	                        @endforeach
	                    </select> 
